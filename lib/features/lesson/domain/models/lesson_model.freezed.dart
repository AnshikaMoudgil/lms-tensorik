...
mixin _$LessonModel {
 ...
 String get id; String get courseId; String get title; String get description; String get videoUrl; int get order;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,courseId,title,description,videoUrl,order);

@override
String toString() {
  return 'LessonModel(id: $id, courseId: $courseId, title: $title, description: $description, videoUrl: $videoUrl, order: $order)';
}
...
@useResult
$Res call({
 String id, String courseId, String title, String description, String videoUrl, int order
});
...
/// Create a copy of LessonModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? courseId = null,Object? title = null,Object? description = null,Object? videoUrl = null,Object? order = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String courseId,  String title,  String description,  String videoUrl,  int order)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LessonModel() when $default != null:
return $default(_that.id,_that.courseId,_that.title,_that.description,_that.videoUrl,_that.order);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String courseId,  String title,  String description,  String videoUrl,  int order)  $default,) {final _that = this;
switch (_that) {
case _LessonModel():
return $default(_that.id,_that.courseId,_that.title,_that.description,_that.videoUrl,_that.order);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String courseId,  String title,  String description,  String videoUrl,  int order)?  $default,) {final _that = this;
switch (_that) {
case _LessonModel() when $default != null:
return $default(_that.id,_that.courseId,_that.title,_that.description,_that.videoUrl,_that.order);case _:
  return null;
...
class _LessonModel extends LessonModel {
  const _LessonModel({required this.id, required this.courseId, required this.title, required this.description, required this.videoUrl, required this.order}): super._();
...
/// Create a copy of LessonModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? courseId = null,Object? title = null,Object? description = null,Object? videoUrl = null,Object? order = null,}) {
